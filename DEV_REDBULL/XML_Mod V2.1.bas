...
'Public XML_PRINT_AREA As String
'Public XML_PRINT_HEAD As String
'Public XML_LAYOUT As XML_Layout_Key

Public Type TYPE_XML_PRINT
    LAYOUT As XML_Layout_Key
    AREA As String
    HEAD As String
End Type

'Données entete / pied de page
Public Type TYPE_XML_TEXTE
    XText As String
...
Public Type TYPE_XML_HEADER
    XLeft As TYPE_XML_TEXTE
    XCenter As TYPE_XML_TEXTE
    XRight As TYPE_XML_TEXTE

    XMargin As Double
End Type


Public XML_FILTRE As Boolean
Public XML_FREEZE As Boolean


Public XML_PRINT As TYPE_XML_PRINT

Public XML_HEADER As TYPE_XML_HEADER
Public XML_FOOTER As TYPE_XML_HEADER
...
If XML_PRINT.HEAD <> "" Or XML_PRINT.AREA <> "" Then
    Print #XFile, "  <Names>"
    
    If XML_PRINT.HEAD <> "" Then
        Print #XFile, "   <NamedRange ss:Name=" & Chr(34) & "Print_Titles" & Chr(34) & " ss:RefersTo=" & Chr(34) & "=" & XML_PRINT.HEAD & Chr(34) & "/>"
    End If
    
    If XML_PRINT.AREA <> "" Then
        Print #XFile, "   <NamedRange ss:Name=" & Chr(34) & "Print_Area" & Chr(34) & " ss:RefersTo=" & Chr(34) & "=" & XML_PRINT.AREA & Chr(34) & "/>"
    End If
...
'    <Layout x:CenterHorizontal=" & chr(34) & "1" & chr(34) & "/>
'    <Header x:Margin=" & chr(34) & "0.43307086614173229" & chr(34) & "/>
'    <Footer x:Margin=" & chr(34) & "0.31496062992125984" & chr(34) & "/>
'    <PageMargins x:Bottom=" & chr(34) & "0.74803149606299213" & chr(34) & " x:Left=" & chr(34) & "0.23622047244094491" & chr(34) & "
'     x:Right=" & chr(34) & "0.23622047244094491" & chr(34) & " x:Top=" & chr(34) & "0.47244094488188981" & chr(34) & "/>

'    <Layout x:Orientation=" & chr(34) & "Landscape" & chr(34) & " x:CenterHorizontal=" & chr(34) & "1" & chr(34) & "/>"
'    <Header x:Margin=" & chr(34) & "0.43307086614173229" & chr(34) & "/>"
'    <Footer x:Margin=" & chr(34) & "0.31496062992125984" & chr(34) & "/>"
'    <PageMargins x:Bottom=" & chr(34) & "0.74803149606299213" & chr(34) & " x:Left=" & chr(34) & "0.23622047244094491" & chr(34)
'     x:Right=" & chr(34) & "0.23622047244094491" & chr(34) & " x:Top=" & chr(34) & "0.47244094488188981" & chr(34) & "/>"
...
'Orientation page
If XML_PRINT.LAYOUT = XML_Portrait Then
    Print #XFile, "    <Layout x:CenterHorizontal=" & Chr(34) & "1" & Chr(34) & "/>"
ElseIf XML_PRINT.LAYOUT = XML_Paysage Then
    Print #XFile, "    <Layout x:Orientation=" & Chr(34) & "Landscape" & Chr(34) & " x:CenterHorizontal=" & Chr(34) & "1" & Chr(34) & "/>"
End If

'Entete
If XML_HEADER.XLeft.XText <> "" Or XML_HEADER.XCenter.XText <> "" Or XML_HEADER.XRight.XText <> "" Then
    Print #XFile, "    <Header x:Margin=" & Chr(34) & CStr(Replace(XML_HEADER.XMargin, ",", ".")) & Chr(34) '& "/>"
    
    hTexte = XML_HEADER_FOOTER(XML_HEADER.XLeft, "L")
    hTexte = hTexte & XML_HEADER_FOOTER(XML_HEADER.XCenter, "C")
    hTexte = hTexte & XML_HEADER_FOOTER(XML_HEADER.XRight, "R")
     
    Print #XFile, "     x:Data=" & Chr(34) & hTexte & Chr(34) & "/>"
Else
    Print #XFile, "    <Header x:Margin=" & Chr(34) & "0.42" & Chr(34) & "/>"
End If

'Pied de page
If XML_FOOTER.XLeft.XText <> "" Or XML_FOOTER.XCenter.XText <> "" Or XML_FOOTER.XRight.XText <> "" Then
    Print #XFile, "    <Footer x:Margin=" & Chr(34) & CStr(Replace(XML_FOOTER.XMargin, ",", ".")) & Chr(34) '& "/>"
    
    hTexte = XML_HEADER_FOOTER(XML_FOOTER.XLeft, "L")
    hTexte = hTexte & XML_HEADER_FOOTER(XML_FOOTER.XCenter, "C")
    hTexte = hTexte & XML_HEADER_FOOTER(XML_FOOTER.XRight, "R")
     
    Print #XFile, "     x:Data=" & Chr(34) & hTexte & Chr(34) & "/>"
Else
    Print #XFile, "    <Footer x:Margin=" & Chr(34) & "0.42" & Chr(34) & "/>"
End If
...
'     x:Data="&amp;C&amp;&quot;Arial,Gras&quot;&amp;12RECEPTIONS du 31 mai 2010 au 21 juin 2010&amp;R&amp;&quot;Arial,Normal&quot;&amp;10Etat du 21 juin 2010"/>

Print #XFile, "    <PageMargins x:Bottom=" & Chr(34) & "0.74" & Chr(34) & " x:Left=" & Chr(34) & "0.25" & Chr(34) & " x:Right=" & Chr(34) & "0.25" & Chr(34) & " x:Top=" & Chr(34) & "0.56" & Chr(34) & "/>"

Print #XFile, "   </PageSetup>"
Print #XFile, "   <NoSummaryRowsBelowDetail/>"
Print #XFile, "   <FitToPage/>"
Print #XFile, "   <Print>"
Print #XFile, "    <FitHeight>0</FitHeight>"
...
If XML_FREEZE = True Then
    Print #XFile, "   <FreezePanes/>"
    Print #XFile, "   <FrozenNoSplit/>"
    Print #XFile, "   <SplitHorizontal>1</SplitHorizontal>"
    Print #XFile, "   <TopRowBottomPane>1</TopRowBottomPane>"
    Print #XFile, "   <ActivePane>2</ActivePane>"
    Print #XFile, "   <Panes>"
    Print #XFile, "    <Pane>"
    Print #XFile, "     <Number>3</Number>"
    Print #XFile, "    </Pane>"
    Print #XFile, "    <Pane>"
    Print #XFile, "     <Number>2</Number>"
    Print #XFile, "     <ActiveRow>1</ActiveRow>"
    Print #XFile, "     <ActiveCol>0</ActiveCol>"
    Print #XFile, "    </Pane>"
    Print #XFile, "   </Panes>"
End If
...
If XML_FILTRE = True Then
    Print #XFile, "  <AutoFilter x:Range=" & Chr(34) & "R1C1:R1C" & CStr(XML_NColonnes) & Chr(34) & " xmlns=" & Chr(34) & "urn:schemas-microsoft-com:office:excel" & Chr(34) & ">"
    Print #XFile, "  </AutoFilter>"
End If
...
XML_PRINT.AREA = ""
XML_PRINT.HEAD = ""
XML_PRINT.LAYOUT = XML_Portrait


XML_HEADER.XMargin = 0.24

XML_HEADER.XLeft.XText = ""
XML_HEADER.XLeft.XBold = False
XML_HEADER.XLeft.XLine = False
XML_HEADER.XLeft.XFont = "Arial"
XML_HEADER.XLeft.XSize = 11

XML_HEADER.XCenter.XText = ""
XML_HEADER.XCenter.XBold = False
XML_HEADER.XCenter.XLine = False
XML_HEADER.XCenter.XFont = "Arial"
XML_HEADER.XCenter.XSize = 11

XML_HEADER.XRight.XText = ""
XML_HEADER.XRight.XBold = False
XML_HEADER.XRight.XLine = False
XML_HEADER.XRight.XFont = "Arial"
XML_HEADER.XRight.XSize = 11



XML_FOOTER.XMargin = 0.24

XML_FOOTER.XLeft.XText = ""
XML_FOOTER.XLeft.XBold = False
XML_FOOTER.XLeft.XLine = False
XML_FOOTER.XLeft.XFont = "Arial"
XML_FOOTER.XLeft.XSize = 11

XML_FOOTER.XCenter.XText = ""
XML_FOOTER.XCenter.XBold = False
XML_FOOTER.XCenter.XLine = False
XML_FOOTER.XCenter.XFont = "Arial"
XML_FOOTER.XCenter.XSize = 11

XML_FOOTER.XRight.XText = ""
XML_FOOTER.XRight.XBold = False
XML_FOOTER.XRight.XLine = False
XML_FOOTER.XRight.XFont = "Arial"
XML_FOOTER.XRight.XSize = 11
...
Public Function XML_HEADER_FOOTER(XHeader As TYPE_XML_TEXTE, XAlignment) As String

t = ""

If XHeader.XText <> "" Then
    t = "&amp;" & XAlignment & "&amp;&quot;" & XHeader.XFont & ","

    If XHeader.XBold = True Then
        t = t & "Gras"
    Else
        t = t & "Normal"
    End If

    t = t & "&quot;&amp;" & CStr(XHeader.XSize)
    t = t & XHeader.XText
End If
...
Public Function XML_HEADER_TXT() As String
